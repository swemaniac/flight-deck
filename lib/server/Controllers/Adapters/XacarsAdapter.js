...
class XacarsAdapter extends BaseAdapter {
    ...
    respondMessage(data) {
        var acarspos = new (this._positionModel)();
    ...
    respondBeginFlight(data) {
        ...
        var acarsFlight = new (this._flightModel)();
        ...
        if (flightData[5].length != 0) {
            ...
            acarsFlight.departure = plan[0].toUpperCase();
        ...
        acarspos.distTotal    = flightData[16];
        acarspos.msgdata      = data.data3;

        acarspos.save();

        return '1|' + acarsFlight._id;
    }
