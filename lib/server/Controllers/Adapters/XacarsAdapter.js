...
class XacarsAdapter extends BaseAdapter {
    ...
    handleRequest(req, res) {
        ...
        switch(requestData.data2) {
            case 'TEST':
                response = respondTest(requestData);
            break;
            case 'MESSAGE':
                response = respondMessage(requestData);
            break;
            case 'BEGINFLIGHT':
                response = respondBeginFlight(requestData);
            break;
            case 'PAUSEFLIGHT':
                response = respondPauseFlight(requestData);
            break;
            case 'ENDFLIGHT':
                response = respondEndFlight(requestData);
            break;
            default: 
