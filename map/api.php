<?php
    ...
    function connect() {
        return new PDO('mysql:host=localhost;dbname=flight_deck;charset=utf8mb4', 'flight_deck', DB_PASS, array(PDO::ATTR_EMULATE_PREPARES => false, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
    }
?>